...
"""
print(sum(monthly_spending[:6]) / 6, sum(monthly_spending[6:]) / 6)
"""
...
"""
print(sum(j > s for j, s in zip(john_monthly_spending, sam_monthly_spending)))
"""
...
"""
print(set(paul_friends) & set(tina_friends))
"""
...
"""
print(set(football_players - (volleyball_players | basketball_players)))
"""
...
"""
print(*(f"{i}: {poll_results.count(i)}" for i in set(poll_results)), sep='\n')
"""
...
"""
---
"""print(sum({v for v in dict(scores.sort() or scores).values()}))"""
"""
...
"""
print(max(numbers), sum(numbers), sum(numbers) / len(numbers))
"""
...
"""
print(max(word_list, key=len), min(word_list, key=len))
"""
...
"""
print(set(i for i in number_list if number_list.count(i) >= 3))
"""
...
"""
print(max((exam_results).remove(max(exam_results)) or exam_results))